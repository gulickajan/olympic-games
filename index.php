<?php
    ...
    try
    {
        $stmt = $myPdo->query("SELECT person.name, person.surname, place.year, place.country, place.type, position.discipline FROM position INNER JOIN place ON position.place_id = place.id INNER JOIN person ON position.person_id = person.id");
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-lg-0">
                    <li class="nav-item">
                        <a href="Login.php" class="navbar-brand">Prihlásiť</a>
                    </li>
                </ul>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-lg-0">
                    <li class="nav-item">
                        <a href="Register.php" class="nav-link active">Registrovať</a>
                    </li>
                </ul>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-lg-0">
                    <li class="nav-item">
                        <a href="Bestof10.php" class="nav-link active">Najlepší Športovci</a>
                    </li>
                </ul>
            </div>
        </div>
